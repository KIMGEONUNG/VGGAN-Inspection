...
if __name__ == "__main__":
  ...
  model16384 = load_vqgan(
      config16384,
      ckpt_path="logs/vqgan_imagenet_f16_16384/checkpoints/last.ckpt").to(
          DEVICE)
  ## Load f16, 1024
  ...
  model1024 = load_vqgan(
      config1024,
      ckpt_path="logs/vqgan_imagenet_f16_1024/checkpoints/last.ckpt").to(
          DEVICE)

  titles = [
      "Input", "VQGAN (f8, 8192)", "VQGAN (f16, 16384)", "VQGAN (f16, 1024)"
  ]
  img = reconstruction_pipeline(
      url='https://heibox.uni-heidelberg.de/f/7bb608381aae4539ba7a/?dl=1',
      size=384)
  img.save('outputs/sample1.jpg')

  img = reconstruction_pipeline(
      url='https://heibox.uni-heidelberg.de/f/6f12b330eb564d288d76/?dl=1',
      size=384)
  img.save('outputs/sample2.jpg')

  img = reconstruction_pipeline(
      url='https://heibox.uni-heidelberg.de/f/8555a959b0a5423cbfd1/?dl=1',
      size=384)
  img.save('outputs/sample3.jpg')

  img = reconstruction_pipeline(
      url='https://heibox.uni-heidelberg.de/f/be6f4ff34e1544109563/?dl=1',
      size=384)
  img.save('outputs/sample4.jpg')

  img = reconstruction_pipeline(
      "https://heibox.uni-heidelberg.de/f/e41f5053cbd34f11a8d5/?dl=1",
      size=384)
  img.save('outputs/sample5.jpg')
